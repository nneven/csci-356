...
- **Important for DataLab 2:** For floating-point puzzles, the coding rules are
  less strict. You are allowed to use:
  ...
  5. Use any data type other than `int` / `unsigned int` (e.g., arrays, structs, or unions.)
